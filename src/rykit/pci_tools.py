...
def check_if_valid_pcie(domain:int, bus:int,device:int,func:int,offset:int) -> None:
    """
...
def pciConfigWrite32(domain:int, bus:int,device:int,func:int,offset:int,data:int) -> None:
    """
